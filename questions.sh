...
if [[ ("$wireguard" == "true") ]]; then
message_box "SabiasQueSpace YiiMP Server Installer" \
...
# To increase security we are now randomly generating the YiiMP Frontend DB name, panel, and stratum user names. So each installation is more secure.
